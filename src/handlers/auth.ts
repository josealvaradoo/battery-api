...
/**
 * @deprecated This authentication endpoint is deprecated and will be removed in a future version.
 * @param {Context} c - The Hono context object
 * @returns {Promise<Response>} JSON response with token on success or error message on failure
 */
 ...
 * @param {Context} c - The Hono context object
 * @returns {Promise<Response>} JSON response with JWT token on success or error message on failure
 */
...
/**
 * Revokes a Google OAuth session
 * @param {Context} c - The Hono context object
 * @returns {Promise<Response>} JSON response with success status or error message
 */
 ...
 * @param {Context} c - The Hono context object
 * @returns {Promise<Response>} JSON response confirming authentication status
 */
